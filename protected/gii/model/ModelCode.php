...
class ModelCode extends CCodeModel
{
	...
	public function generateLabels($table)
	{
		...
		foreach($table->columns as $column)
		{
			if(in_array($column->name, array('create_time','update_time','created_by','updated_by'))){
				continue;
			}
	...
	public function generateRules($table)
	{
		...
		foreach($table->columns as $column)
		{
			if($column->autoIncrement || in_array($column->name, array('create_time','update_time','created_by','updated_by')))
				continue;
